...
class Story(BaseModel):
    ...
    def get_available_content(self, current_container: Optional[Container] = None) -> list[Container]:
    ...
    def _evaluate_condition(self, condition: Condition, container_id: Optional[int] = None) -> bool:
